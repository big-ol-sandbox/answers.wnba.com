{{> cards/card_component componentName='athlete-card' }}

class athlete_cardCardComponent extends BaseCard['athlete-card'] {
  ...
  static defaultTemplateName (config) {
    return 'cards/athlete-card';
  }
}

ANSWERS.registerTemplate(
  'cards/athlete-card',
  {{{stringifyPartial (read 'cards/athlete-card/template') }}}
);
ANSWERS.registerComponentType(athlete_cardCardComponent);
