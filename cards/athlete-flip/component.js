{{> cards/card_component componentName='athlete-flip' }}

class athlete_flipCardComponent extends BaseCard['athlete-flip'] {
  ...
  dataForRender(profile) {
    ...
    return {
      ...
      height: 'Height: ' + profile.c_height,
      weight: 'Weight: ' + profile.c_weight, 
      dateofbirth: `Date of Birth: ` + profile.c_dateOfBirth,
      yearspro: 'Years Pro: ' + profile.yearsOfExperience,
      position: profile.c_linkedTeams[0].name + " • " + profile.c_position + " • " + profile.c_jersey,
  ...
  static defaultTemplateName (config) {
    return 'cards/athlete-flip';
  }
}

ANSWERS.registerTemplate(
  'cards/athlete-flip',
  {{{stringifyPartial (read 'cards/athlete-flip/template') }}}
);
ANSWERS.registerComponentType(athlete_flipCardComponent);
