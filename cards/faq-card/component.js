{{> cards/card_component componentName='faq-card' }}

class faq_cardCardComponent extends BaseCard['faq-card'] {
  ...
  static defaultTemplateName (config) {
    return 'cards/faq-card';
  }
}

ANSWERS.registerTemplate(
  'cards/faq-card',
  {{{stringifyPartial (read 'cards/faq-card/template') }}}
);
ANSWERS.registerComponentType(faq_cardCardComponent);
