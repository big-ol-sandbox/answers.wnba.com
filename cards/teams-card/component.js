{{> cards/card_component componentName='teams-card' }}

class teams_cardCardComponent extends BaseCard['teams-card'] {
  ...
  static defaultTemplateName (config) {
    return 'cards/teams-card';
  }
}

ANSWERS.registerTemplate(
  'cards/teams-card',
  {{{stringifyPartial (read 'cards/teams-card/template') }}}
);
ANSWERS.registerComponentType(teams_cardCardComponent);
